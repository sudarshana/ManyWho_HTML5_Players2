...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultItems = [
		...
		{ label:'Formats', type:'group', items: [
			...
			{ type:'separator' },
			{ label:'Formatting', type: 'size', items: [
				{ label:'Normal',  value:'14px', selected:true },
				{ label:'Heading 6',  value:'11px' },
				{ label:'Heading 5',  value:'13px' },
				{ label:'Heading 4',  value:'15px' },
				{ label:'Heading 3',  value:'19px' },
